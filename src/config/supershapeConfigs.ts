...
export const allSupershapeConfigs: SupershapeConfig[] = [
  ...
  // Code 11 (MakeMesh - Vase example)
  {
    ...
    params: {
      a1: 1, b1: 1, a2: 1, b2: 1,
      m1: 4, n11: -12, n12: 1, n13: 1,
      m2: 8.5, n21: 1, n22: -1, n23: -2,
      inc: 180,
    },
  },
  // Code 12
  ...
  // Code 14
  {
    type: "supershape",
    params: {
      params1: { m: 8, n1: 100, n2: 38.1786553544725, n3: -34, a: 0.536393322550127, b: 0.287026581621754 },
      params2: { m: 9, n1: 100, n2: 300, n3: 12, a: 1.42240668965728, b: 1.12839136936552 },
      resol: 300,
    },
  },
  // Code 15
  {
    type: "supershape",
    params: {
      params1: { m: 14, n1: 250, n2: 38.1786553544725, n3: -34, a: 0.536393322550127, b: 0.287026581621754 },
      params2: { m: 9, n1: 600, n2: 600, n3: 12, a: 1.42240668965728, b: 1.12839136936552 },
      resol: 800,
    },
  },
  // Code 16 - Cactus (SuperShapeMesh)
  {
    ...
    params: {
      M1: 26, A1: 100, B1: 8, N11: 55, N12: 5, N13: 5,
      M2: 50, A2: 50, B2: 10, N21: 7.5, N22: 10, N23: 100,
      ResTh: 120, ResPh: 120,
    },
  },
  // Code 16 - Flower (SuperShapeMesh)
  {
    type: "supershape_mesh",
    params: {
      M1: 52, A1: 10.0, B1: 16.0, N11: 15, N12: 50, N13: 5,
      M2: 50, A2: 50, B2: 10, N21: 7.5, N22: 10, N23: 10.0,
      ResTh: 150, ResPh: 150,
    },
  },
];
