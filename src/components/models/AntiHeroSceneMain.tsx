...
export default function AntiheroScene({
  ...
  useEffect(() => {
    ...
    apiAntiheroLogo.start({
      scale: activeGroup === "AntiheroLogo" ? 1 : 0,
    });
    apiXaeneptune.start({
      scale: activeGroup === "Xaeneptune" ? 1 : 0,
    });
    apiContact.start({
      scale: activeGroup === "Contact" ? 1 : 0,
    });
    apiArtist.start({
      scale: activeGroup === "Artist" ? 1 : 0,
    });
    apiMusic.start({
      scale: activeGroup === "Music" ? 1 : 0,
    });
    apiBeats.start({
      scale: activeGroup === "Beats" ? 1 : 0,
    });
    apiAlbums.start({
  ...
  useFrame((_, delta) => {
    if (floatingMonitorsRef.current) {
      floatingMonitorsRef.current.rotation.y += delta * 0.15;
    }
  });
  ...
  return (
    <group ref={groupRef} {...props} dispose={null}>
      <group name="Scene">
        ...
        */}
        ...
        >
        <group name="RootNode" position={[0.474, 0, 0]} scale={0.007}>
    ...
    {/*
        ...
        */}
        ...
        <group name="XaeNeptuneWorld" position={[0.474, 2.712, 0]} scale={0.283}>
        ...
        */}
        ...
        <mesh name="Floor_Center" geometry={nodes.Floor_Center.geometry} material={materials.Blue_Emission} position={[0.474, -1.433, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={[3.848, 3.848, 0.264]} />
        ...
        */}
        ...
        >
        <group name="ANTIHERO" position={[-0.101, 3.076, -0.289]} rotation={[1.457, 0, 0]} scale={[25.024, 5.166, 25.024]}>
